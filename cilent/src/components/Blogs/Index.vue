...
<b-container class="bv-example-row">
  ...
  <div class="" >
    ...
    <h1>การสั่งซื้อหนังสือการ์ตูน
    </h1>
  <!--   <p><button v-on:click="logout">Logout</button></p> -->
    <h5>จำนวนการสั่งซื้อ {{ blogs.length }} </h5>
<hr>
    <p><b-button pill variant="success" v-on:click="navigateTo('/blog/create')"> สั่งซื้อหนังสือการ์ตูน </b-button></p>
...
<br>
    <div class="box1" v-for="blog in blogs" v-bind:key="blog.id">
      ...
      <p>ชื่อหนังสือการ์ตูน: {{ blog.nitem }}</p>
