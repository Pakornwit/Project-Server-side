    ...
    <b-container class="bv-example-row">
      <b-row class="text-left">
        ...
        <b-col cols="10" class="bg1">
          <h1>การสั่งซื้อหนังสือการ์ตูน</h1>
          <hr />
          ...
          <form class="box1" v-on:submit.prevent="createBlog">
            ...
            <p> รายชื่อหนังสือการ์ตูน :
              <select required class="form-control"  v-model="blog.nitem">
                      <option>หนังสือหมายเลขที่ 1(นารูโตะ)</option>
                      <option>หนังสือหมายเลขที่ 2(โดเรม่อน)</option>
                      <option>หนังสือหมายเลขที่ 3(วันพีช)</option>
                      <option>หนังสือหมายเลขที่ 4(One-PunchMan)</option>
                      <option>หนังสือหมายเลขที่ 5(ดาบพิฆาตอสูร)</option>
            ...
            <p> วันที่สั่งหนนังสือ : <input type="date" required class="form-control" v-model="blog.dates" /></p>
