<template>
    <div>
        <div class="sidebar"> 
            <div class="img">
                <p><img src="../assets/logo-removebg.png"></p>
            </div>
            <a><router-link :to="{name: 'items'}"> รายละเอียดหนังสือการ์ตูน</router-link></a> 
            <a><router-link :to="{name: 'blogs'}"> การสั่งซื้อหนังสือการ์ตูน</router-link></a>
